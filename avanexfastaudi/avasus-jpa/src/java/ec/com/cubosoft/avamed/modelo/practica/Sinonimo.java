 ...
 */
@Entity
@Table(name = "sinonimo", catalog = "avasus", schema = "practica")
@NamedQueries({
...
public class Sinonimo implements Serializable {
    ...
    @Id
    @SequenceGenerator(name="SINONIMO_ID_GENERATOR",sequenceName="PRACTICA.SINONIMO_ID_SEQ",allocationSize=1)
    @GeneratedValue(strategy=GenerationType.SEQUENCE,generator="SINONIMO_ID_GENERATOR")
    @Basic(optional = false)
    @Column(name = "id")
    private Integer id;
    @Basic(optional = false)
    ...
    public Sinonimo(Integer id, String descripcion, Date fecIni, short lockReg, String firstUser, long idNombre) {
        this.id = id;
    ...
    public String toString() {
        return "ec.com.cubosoft.avamed.modelo.practica.Sinonimo[id=" + id + "]";
    }
