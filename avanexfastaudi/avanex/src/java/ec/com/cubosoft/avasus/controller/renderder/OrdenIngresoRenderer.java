...
public class OrdenIngresoRenderer implements RowRenderer {
    ...
    public void render(Row row, Object data, int index) throws Exception {
        if (!(slab)) {
            ...
            final Label fechaIngreso = new Label(fecha.format(orden.getFecIngreso()));
            fechaIngreso.setParent(row);
            ...
            if (resultadoXorden.size() > 0) {
                XmlResultado resul = (XmlResultado) resultadoXorden.get(0);
                urgen = String.valueOf(reportes.preferenciaOrden(resul.getIdOrdenNextlab()));
            }

            if (!(urgen.equalsIgnoreCase("S"))) {
                urgen = "NORMAL";
            } else {
                urgen = "URGENTE";
            }
            ...
            final Label pacienteH = new Label(orden.getHistoria().getPaciente());
            pacienteH.setParent(row);

            final Label organizacion = new Label();

            if (orden.getOrganizacion() != null) {
                organizacion.setValue(orden.getOrganizacion().getAbreviatura());
                organizacion.setParent(row);
            } else {
                organizacion.setValue("(Sin Empresa)");
                organizacion.setParent(row);
            }
...
//            }
            ...
            if (!(practicasXOrden.isEmpty())) {
                ...
                //Erick
                //imagen rayos x tamaño de la celda
                Listheader tamanoimgenrayosx = new Listheader();
                tamanoimgenrayosx.setAlign("center");
                tamanoimgenrayosx.setWidth("15%");
                tamanoimgenrayosx.setParent(peticionesCab);
                ...
                for (PracticaXOrden practica : practicasXOrden) {
                    ...
                    Image imageLock, imagenRayosX;
                    Listcell audito = new Listcell();
                    Listcell celdaRayoX = new Listcell();
                    ...
                    //ERICK
                    //PARA QUITAR LOS AUDITADOS
//                    if (((practica.getStsTecnico().equals("AU"))||(practica.getStsTecnico().equals("VA")))
//                            && ((practica.getPractica().getId() == 1518) || (practica.getPractica().getId() == 1521))) {
//                        cambiarEstado.setLabel(" CAMBIAR A CO");
...
//                      
                        ...
                        if (practica.getIdArea() != null) {
                            if ((practica.getIdArea() == 23
                                ...
                                Map<String, Object> wSQL1 = new HashMap<String, Object>();

                                wSQL1.put("idOrden", practica.getOrden().getId());
                                wSQL1.put("idPractica", practica.getPractica().getId());
                                String link = "";

                                link = reportes.getReportXmllink(wSQL1, 9, practica.getOrden().getId().toString(), true, true);

                                if ((link == null)) {
                                    link = reportes.getReportXmllinkAudimagen(wSQL1, 10, practica.getOrden().getId().toString(), true, true);
                                }
                                if (link != null) {
                                    System.out.println("entro" + link);
                                    //String aux="";
                                    String aux = link.replace("192.168.57.21:80", "186.5.109.243:81");//replaces all occurrences of 'a' to 'e'                                                                  
                                    //Executions.getCurrent().sendRedirect(aux, "_blank");
                                    pathImagenRayosX = "/images/rayosx2.png";
                                } else {
                                    //Messagebox.show("INFORME NO TIENE IMAGEN/NO SE PUEDE RENDERIZAR");
                                    System.out.println("no ent");
                                }
                                //Erick
                            } else {
                                audiotoriaPdf.setVisible(false);
...
//                                        } else if ((practica.getStsTecnico().equals("IM"))
                        ...
                        if ((practica.getStsTecnico().equals("PE")) || (practica.getStsTecnico().equals("CM")) || (practica.getStsTecnico().equals("SM")) || (practica.getStsTecnico().equals("VA"))) {
                            ...
                            if (practica.getStsTecnico().equals("AU")) {
                                ...
                                if (practica.getIdArea() != null) {
                                    if ((practica.getIdArea() == 23
                                        ...
                                        String link = "";
                                        // iReport reportes = new iReport();
                                        //link = getReportXmllink(wSQL, 8, practica.getOrden().getId().toString(), true, true);
                                        link = reportes.getReportXmllink(wSQL1, 9, practica.getOrden().getId().toString(), true, true);
...
//                                    cargarPdf.setUpload("true");
                                                ...
                                                if (media != null) {
                                                    ...
                                                    if (practica.getStsTecnico().equals("PE")) {
                                                        ...
                                                        if (pdf != null) {
                                                            ...
                                                            || (practica.getStsTecnico().equals("CO"))
                                                            || (practica.getStsTecnico().equals("SM"))
                                            ...
                                            public void onEvent(UploadEvent t) throws Exception {
                                                try {
                                                    ...
                                                    if (media != null) {
                                                        ...
                                                        PracticaXOrden actualizar = peticion.getValue();
                                                        //if (practica.getStsTecnico().equals("PE")) {
                                                        if ((practica.getStsTecnico().equals("PE")) || (practica.getStsTecnico().equals("CM")) || (practica.getStsTecnico().equals("IN")) || (practica.getStsTecnico().equals("IM"))) {
                                                            XmlResultado idxmlRes = new XmlResultado();
                                                            Map<String, Object> wSQL = new HashMap<>();
                                                            wSQL = new HashMap<>();
                                                            wSQL.put("id ?=", actualizar.getPractica().getId());
                    ...
                    imagenRayosX = new Image(pathImagenRayosX);
                    imagenRayosX.setWidth(
                            "30px");
                    imagenRayosX.setParent(celdaRayoX);
...
//              Fin ToolTip
                    ...
                    //rayosx
                    //Erick
                    imagenRayosX.addEventListener(Events.ON_CLICK, new EventListener() {
                        @Override
                        public void onEvent(Event t) throws Exception {
                            boolean vista = false;
                            PracticaXOrden practica;
                            ...
                            if (vista) {
                                ...
                                wSQL.put("idPractica", practica.getPractica().getId());
                                String link = "", linkaudimagen;
                                iReport reportes = new iReport();
                                //link = getReportXmllink(wSQL, 8, practica.getOrden().getId().toString(), true, true);
                                link = reportes.getReportXmllink(wSQL, 9, practica.getOrden().getId().toString(), true, true);

                                if ((link == null)) {
                                    link = reportes.getReportXmllinkAudimagen(wSQL, 10, practica.getOrden().getId().toString(), true, true);
                                }

                                if (link != null) {
                                    //System.out.println("zelda" + link);
                                    String aux = link.replace("192.168.57.21:80", "186.5.109.243:81");//replaces all occurrences of 'a' to 'e'                                                                  
                                    Executions.getCurrent().sendRedirect(aux, "_blank");
                                } else {
                                    Messagebox.show("INFORME NO TIENE IMAGEN/NO SE PUEDE RENDERIZAR");
...
//IMPRIMIR PRACTICA
                    ...
                    //rayosx
                    peticion.appendChild(celdaRayoX);
...
//              Fin ToolTip
            ...
            // final List<XmlResultado> resultadoXordennew Label(String.valueOf(orden.getOrigen().getDescripcion())).setParent(row);
            final Label ordenDescripcion = new Label(String.valueOf(orden.getOrigen().getDescripcion()));
            ordenDescripcion.setParent(row);

//jordan
            //new Label(urgen).setParent(row);
            //new Label(String.valueOf(orden.getOrigen().getDescripcion())).setMultiline(true);
            //setParent(row);
            //new Label(String.valueOf(orden.getOrigen().getDescripcion())).setParent(row);
            final Label urgente = new Label(urgen);
            if (urgen.equalsIgnoreCase("URGENTE")) {
                urgente.setStyle("color:red");
                ordenDescripcion.setStyle("color:red");
                usuario.setStyle("color:red");
                pacienteH.setStyle("color:red");
                fechaIngreso.setStyle("color:red");
                imprimirOrden.setStyle("color:red");
                organizacion.setStyle("color:red");

            } else {
                urgente.setStyle("color:black");
            }

            urgente.setParent(row);
            //new Label(urgen).setParent(row);
