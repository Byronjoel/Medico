 ...
 * @author JP
 */
public class OrdenIngresoRendererErick implements RowRenderer {
    ...
    public OrdenIngresoRendererErick(String usuarioe, Boolean impre, Boolean dell, Window imgre, Boolean sl) {
        usuario = usuarioe;
        imprimir = impre;
        delet = dell;
        WinIngreso = imgre;
