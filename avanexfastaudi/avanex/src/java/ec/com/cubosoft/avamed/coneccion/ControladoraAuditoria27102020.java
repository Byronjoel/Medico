 ...
 * @version 1.0
 */
public class ControladoraAuditoria27102020 extends GenericForwardComposer {
        ...
        btnpopup.addEventListener(Events.ON_CLICK, new EventListener() {
            ...
            public void onEvent(Event t) throws Exception {
                ...
                try {
                    ...
                    Logger.getLogger(ControladoraAuditoria27102020.class.getName()).log(Level.SEVERE, null, ex);
