 ...
 */
@Embeddable
public class STrausuPK implements Serializable {
    ...
    public STrausuPK(String usuario, String transac) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof STrausuPK)) {
            return false;
        }
        STrausuPK other = (STrausuPK) object;
    ...
    public String toString() {
        return "ec.com.cubosoft.avamed.modelo.nextla.STrausuPK[ usuario=" + usuario + ", transac=" + transac + " ]";
    }
