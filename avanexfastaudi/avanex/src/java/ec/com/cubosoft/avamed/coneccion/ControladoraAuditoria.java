 ...
 * @version 1.0
 */
public class ControladoraAuditoria extends GenericForwardComposer {
    ...
    Button btnBuscar, btnReset, btnCancel, btnNew, btnGuardar, btnOpen,
            btnPreview, btnUpdate, btnDelete, btnPrint, btnSync, btnGraphR, btnByron;
...
//                if ((idMenuPermiso.equalsIgnoreCase("m_archivo")) || ((idMenuPermiso.equalsIgnoreCase("ConsResult")))) {
    ...
    public void enableButtons() {
        try {
            btnByron=(Button)barraBotones.getFellow("btnByron", false);
            ...
            //boton de prueba Byron
            btnByron.setDisabled(false);
            btnByron.setVisible(true);
            btnByron.addEventListener(Events.ON_CLICK, new EventListener(){
...
//    }
    ...
    public void pruebabyron(){

        String dato;
        dato="funciono el boton";
  System.out.println(dato);
    ...
    public void buscar() {
        ...
        cleanGrid();
        try {
//            List<XmlResultado> listResultado = new ArrayList();
//            listResultado = getOrdenesXMLresultado();
          ...
          GridOrdenes.setRowRenderer(new OrdenIngresoRenderer(usuario, impr, delete, WinAuditoria, false, carga));  //carga id de  los datos 
          //  GridOrdenes.setModel(new ListModelList(listResultado));
        ...
        btnpopup.addEventListener(Events.ON_CLICK, new EventListener() {
            ...
            public void onEvent(Event t) throws Exception {
                ...
                try {
                    ...
                    Logger.getLogger(ControladoraAuditoria.class.getName()).log(Level.SEVERE, null, ex);
