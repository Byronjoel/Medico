 ...
 * @author JP
 */
public class PedidoRenderer implements RowRenderer {
    ...
    public PedidoRenderer(String usuarioe, Boolean impre, Boolean dell, Window imgre, Boolean sl) {
        usuario = usuarioe;
        imprimir = impre;
        delet = dell;
        WinIngreso = imgre;
...
//                           admi.actualizar(orden);
                    ...
                    auditar.addEventListener("onClick", new EventListener() {
                        @Override
                        public void onEvent(Event e) throws Exception {
                            AdmiNegocio admi = new AdmiNegocio();
                            for (Object practi : practicasXOrden) {
...
//IMPRIMIR PRACTICA
                        ...
                        public void onEvent(Event event) throws Exception {
                            ...
                            if (mediaCarga != null) {
                                ...
                                //Messagebox.show("El informa todavía no se encuentra liberado");
                            }
                        }
                    });
